    ...
    <div class="topbar">
      <div class="topbar-inner itn-fill">
        <div class="sampleset-container">
			...
			<h3><g:link controller="metaCat" action="list">MetaCat Listing</g:link></h3>
         <ul class="nav secondary-nav">
<%--       	<li><g:link controller="metaCat" target="_blank" class="help noshade" title="Help"></g:link></li> --%>
	            ...
	            <a href="#" class="dropdown-toggle">Tools</a>
          		<ul class="dropdown-menu skin-dropdown">
       				<!-- picks up the current controller at runtime, so specify a fixed controller here. -->
		           		<li><g:link controller="metaCat" action="list">List Collections</g:link></li>
      				<sec:ifLoggedIn>
		           		<li><g:link controller="metaCat" action="create">Create Collection</g:link></li>
            		</sec:ifLoggedIn>
           			<li class="divider"></li>
	               ...
	               <g:if test="${grailsApplication.config.tools.available.contains('mat') }">
      				   <sec:ifLoggedIn>
	                   	<li><g:link controller="analysis" action="list" target="_blank">Analyses List</g:link></li>
	                   </sec:ifLoggedIn>
